...
public class Sintatico implements Constants
{
    ...
    private boolean step() throws LexicalError, SyntaticError, SemanticError
    {
        if (currentToken == null)
        {
            ...
            currentToken = new Token(DOLLAR, "$", pos, Linhas.getInstance().getLinha(pos), scanner.getClasse(DOLLAR));
        }
        ...
        else if (isTerminal(x))
        {
            ...
            {
                throw new SyntaticError(PARSER_ERROR[x], currentToken.getPosition(), Linhas.getInstance().getLinha(currentToken.getPosition()), currentToken.getLexeme());
            }
        }
    ...
    private boolean pushProduction(int topStack, int tokenInput)
    {
        ...
        if (p >= 0)
        {
            ...
            //empilha a produç?o em ordem reversa
