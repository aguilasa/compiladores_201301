...
public class Action_19 implements IAction {

	@Override
	public void execute(RegistroSemantico rs, Token token) throws SemanticError {
		Modulo modulo = rs.getModuloAtual();
		modulo.getCodigo().append("br ").append(modulo.getLabels().poll()).append("\n");
		modulo.getCodigo().append(modulo.getLabels().poll()).append(":").append("\n");
	}
