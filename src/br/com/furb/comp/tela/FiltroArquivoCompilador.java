...
public class FiltroArquivoCompilador extends FileFilter {

	private final String description;
	private final String[] extensions;
	private final String[] lowerCaseExtensions;
	
	public FiltroArquivoCompilador() {
		this.description = "Arquivos ING";
		this.extensions = new String[] { "ing" };
	...
	public FiltroArquivoCompilador(String description, String... extensions) {
